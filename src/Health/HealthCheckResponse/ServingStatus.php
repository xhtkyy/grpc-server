...
namespace Xhtkyy\GrpcServer\Health\HealthCheckResponse;
...
class_alias(ServingStatus::class, \Xhtkyy\GrpcServer\Health\HealthCheckResponse_ServingStatus::class);
