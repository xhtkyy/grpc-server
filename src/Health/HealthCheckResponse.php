...
use Xhtkyy\GrpcServer\Health\Health;
...
class HealthCheckResponse extends \Google\Protobuf\Internal\Message
{
    ...
    public function __construct($data = NULL) {
        \Xhtkyy\GrpcServer\Health\GPBMetadata\Health::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Xhtkyy\GrpcServer\Health\HealthCheckResponse\ServingStatus::class);
        $this->status = $var;
