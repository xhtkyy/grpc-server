...
class ListServiceResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Xhtkyy\GrpcServer\Reflection\ServiceResponse>|\Google\Protobuf\Internal\RepeatedField $service
     *           The information of each service may be expanded in the future, so we use
     *           ServiceResponse message to encapsulate it.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .grpc.reflection.v1alpha.ServiceResponse service = 1;</code>
     * @param array<\Xhtkyy\GrpcServer\Reflection\ServiceResponse>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setService($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Xhtkyy\GrpcServer\Reflection\ServiceResponse::class);
        $this->service = $arr;
